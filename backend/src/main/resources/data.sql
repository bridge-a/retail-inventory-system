...
ALTER TABLE user_account ALTER COLUMN id RESTART WITH 10;
ALTER TABLE product_category ALTER COLUMN id RESTART WITH 10;
ALTER TABLE product ALTER COLUMN id RESTART WITH 10;
ALTER TABLE purchase_order ALTER COLUMN id RESTART WITH 10;
ALTER TABLE purchase_order_item ALTER COLUMN id RESTART WITH 10;
ALTER TABLE stock_record ALTER COLUMN id RESTART WITH 10;
ALTER TABLE stock_warning ALTER COLUMN id RESTART WITH 10;
